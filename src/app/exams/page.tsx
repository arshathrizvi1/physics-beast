...
export default function ExamsPage() {
  ...
  const hasActiveFilters = searchQuery !== "" || statusFilter !== 'all' || typeFilter !== 'all' || groupBy !== 'folder' || sortBy !== 'newest';
  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-16">
      ...
      {/* 📁 EXAM ARCHIVE & ORGANIZER (Filter & Group Controls) */}
      <section className="space-y-6 pt-6 border-t border-border/50">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-0.5">
              Filter, search, and group your past, submitted, and closed exams.
            </p>
          </div>

          {hasActiveFilters && (
            <Button size="sm" variant="ghost" onClick={resetFilters} className="text-xs text-muted-foreground hover:text-foreground self-start md:self-auto gap-1">
        ...
        <div className="bg-card border border-border/60 rounded-xl p-4 space-y-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-3">
            ...
            <div className="md:col-span-4 relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 text-sm bg-background border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
              />
              {searchQuery && (
            ...
            <div className="md:col-span-3 flex items-center gap-2">
              ...
              <select
                ...
                className="w-full py-1.5 px-2.5 text-sm bg-background border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
              >
                <option value="folder">📁 By Folder</option>
                <option value="date">📅 By Date / Month</option>
