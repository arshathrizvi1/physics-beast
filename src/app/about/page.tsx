    ...
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-300">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-zinc-400 leading-relaxed">{data.mission}</p>
              <p className="text-lg text-zinc-400 leading-relaxed">{data.vision}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 40 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              {[
                ...
                <div key={i} className="bg-[#111] border border-zinc-800 rounded-2xl p-6 text-center hover:border-[#d4af37]/50 transition-colors">
      ...
      <section className="py-16 bg-[#0c0c0c] border-t border-zinc-900">
        <div className="container mx-auto px-6">
          ...
          <p className="text-zinc-400 text-center mb-12 max-w-2xl mx-auto">{data.whyChooseUs}</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {(data.features || defaultAbout.features).map((f: any, i: number) => (
              <motion.div
                ...
                className="bg-[#111] border border-zinc-800 rounded-2xl p-8 hover:border-[#d4af37]/40 hover:shadow-[0_0_20px_rgba(212,175,55,0.1)] transition-all group"
              >
      ...
      <section className="py-16 border-t border-zinc-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto">Have questions? We're here to help. Reach out to us anytime.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="bg-[#111] border border-zinc-800 rounded-2xl p-6 text-center hover:border-[#d4af37]/40 transition-colors"
              >
