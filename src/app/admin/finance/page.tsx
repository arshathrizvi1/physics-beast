...
export default function FinanceReportPage() {
  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-6 print:bg-white print:p-0">
      <div className="max-w-6xl mx-auto space-y-6 print:max-w-none print:m-0">
      ...
      {/* ========================================================================= */}
      {showStatementModal && (
        <div className="fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto print:p-0 print:bg-white print:static">
          <div className="bg-background border border-border/80 rounded-2xl max-w-4xl w-full max-h-[92vh] flex flex-col shadow-2xl overflow-hidden print:border-none print:shadow-none print:max-h-none print:w-full">
            ...
            <div className="p-6 sm:p-8 overflow-y-auto flex-1 space-y-6 text-foreground print:text-black print:p-0">
              
              {/* Document Header */}
              <div className="flex flex-col sm:flex-row justify-between items-start border-b-2 border-primary pb-4 gap-4">
                <div>
                  <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-primary uppercase print:text-black">
                    BRILLIANT ACADEMY
                  </h2>
                  <p className="text-xs uppercase font-bold tracking-widest text-muted-foreground print:text-gray-600">
                ...
                <div className="text-left sm:text-right text-xs space-y-1">
                  <p className="font-bold text-foreground print:text-black">
                    REF: <span className="font-mono text-primary print:text-black">BA-FIN-{Date.now().toString().slice(-7)}</span>
                  </p>
                  <p className="text-muted-foreground print:text-gray-600">
                    Issued: {new Date().toLocaleDateString()} {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                  </p>
                  <p className="text-green-600 font-bold uppercase tracking-wider text-[11px]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-secondary/10 border border-secondary/30 rounded-xl p-4 text-xs print:border-gray-300 print:bg-gray-50">
                ...
                <div className="space-y-1 sm:text-right">
                  ...
                  <p className="text-muted-foreground print:text-gray-600">
                    Generated by: {user.name || user.email} ({user.role.toUpperCase()})
                  </p>
                  <p className="text-muted-foreground print:text-gray-600">
              ...
              {/* KPI Summary Block */}
              <div className="grid grid-cols-3 gap-3 border border-border/50 rounded-xl p-3 text-center print:border-gray-300">
              ...
              <div className="space-y-2">
                ...
                <div className="border border-border/60 rounded-lg overflow-hidden print:border-gray-300">
                  <table className="w-full text-xs text-left">
                    <thead className="bg-secondary/20 uppercase text-[10px] border-b border-border/50 print:bg-gray-100">
                      <tr>
                    ...
                    <tbody className="divide-y divide-border/40">
                      {approvedPayments.length === 0 ? (
                        ...
                        approvedPayments.map((p, idx) => (
                          <tr key={p.id || idx} className="hover:bg-secondary/5">
                    ...
                    <tfoot className="bg-secondary/10 font-bold border-t-2 border-border/80 print:bg-gray-100">
                      <tr>
                        <td colSpan={5} className="p-2.5 text-right uppercase text-[11px]">Total Cleared Revenue:</td>
              ...
              <div className="pt-6 border-t border-secondary/40 grid grid-cols-2 sm:grid-cols-3 gap-6 text-center text-xs print:border-gray-300">
                <div className="space-y-8">
                  <p className="text-[10px] uppercase font-bold text-muted-foreground print:text-gray-600">Authorized Signatory</p>
                  <div className="border-t border-dashed border-border/80 pt-1 text-muted-foreground font-mono text-[11px] print:text-black">
                    Brilliant Academy Finance
                  </div>
                </div>

                <div className="space-y-8">
                  <p className="text-[10px] uppercase font-bold text-muted-foreground print:text-gray-600">Instructor Acknowledgment</p>
                  <div className="border-t border-dashed border-border/80 pt-1 text-muted-foreground font-mono text-[11px] print:text-black">
                ...
                <div className="space-y-8 col-span-2 sm:col-span-1">
                  <p className="text-[10px] uppercase font-bold text-muted-foreground print:text-gray-600">Security Verification</p>
                  <div className="border-t border-dashed border-border/80 pt-1 text-muted-foreground text-[10px] print:text-black">
            ...
            <div className="p-4 border-t border-border/50 bg-secondary/10 flex justify-between items-center print:hidden">
              <p className="text-xs text-muted-foreground">
                Tip: Click "Print / Save PDF" and select "Save as PDF" to download a clean digital document.
              </p>
