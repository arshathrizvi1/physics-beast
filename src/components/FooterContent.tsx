...
export default function FooterContent() {
  ...
  return (
    <div className="container mx-auto px-4">
      {/* Mobile Layout (Flex Columns) */}
      <div className="flex md:hidden justify-between gap-4 mb-2">
        <div className="w-1/2 flex flex-col gap-3">
          <div>
            <h3 className="font-bold text-lg text-primary mb-1">Brilliant Academy</h3>
