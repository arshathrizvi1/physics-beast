            ...
            <div className="flex items-center gap-2 sm:gap-4 shrink-0">
              ...
              {user ? (
                <div className="flex items-center gap-3">
                  <NotificationBell />
                  <Link href={pathname === "/login" || pathname === "/profile" ? "#pfp" : (user.role === "admin" || user.role === "teacher") ? "/admin#myprofile" : "/login"}>
                    <motion.div
            ...
            >
              <div className="flex flex-col p-6 gap-1">
                ...
                {user ? (
                  ...
                  >
                    <Link 
                      href={(user.role === 'admin' || user.role === 'teacher') ? "/admin#myprofile" : "/login"} 
